...
export function StyleguideTable () {
    let data = [
        { id: 0, name: "John Doe", role: 'Administrateur', username: "john_doe", email: 'john_doe@hotmail.fr' },
        { id: 2, name: "Jean Dave", role: 'Utilisateur', username: "jean_dave", email: 'jean_dave@gmail.com' },
        { id: 3, name: "Eva Aleksandar", role: 'Manager', username: "eva_aleksandar", email: 'eva_aleksandar@outlook.fr' },
        { id: 4, name: "Halo Lab", role: 'Utilisateur', username: "halo_lab", email: 'halo_lab@sfr.fr' },
    ]
    return (
        <section>
            <h2>Tables</h2>
